...
GAME ENGINE:
- LUA ERRORS SHOULD BE CAUGHT AND FATAL, stop the game and show the error
- upgrade game engine to natively and transparently use temporal game state at the core, to close the loop on CV latency mitigation - store 1-2 seconds of history for rollback
